...
CATEGORIES = {
    ...
    "model": ("test_preprocessing.py", "test_artifact_bundle.py", "test_data_contract.py", "test_training_pipeline.py", "test_experiment_registry.py", "test_evaluation_gates.py", "test_monitoring_baseline.py", "test_monitoring_engine.py"),
    ...
    "all": (
        ...
        "test_preprocessing.py", "test_artifact_bundle.py", "test_prediction_api.py", "test_telemetry.py", "test_training_pipeline.py", "test_experiment_registry.py", "test_evaluation_gates.py", "test_monitoring_baseline.py", "test_monitoring_engine.py",
