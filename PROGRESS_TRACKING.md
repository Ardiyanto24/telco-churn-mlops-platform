...
- Overall program: **M0-M10 complete; M11 is the next recommended milestone.**
...
| M10 | Continuous integration | Done | Required GitHub Actions checks, security controls, and runtime smoke validation. |
| M11-M21 | Remaining lifecycle | Not started | Follow dependency order in the implementation plan. |
